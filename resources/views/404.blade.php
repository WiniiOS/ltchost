...
<body>
    ...
    <div class="main">
        ...
        <section class="ptb-100 bg-image full-height" data-overlay="8">
            <div class="background-image-wraper" style="background: url('assets/img/hero-2.jpg'); opacity: 1;"></div>
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="error-content-wrap text-center text-white">
                            ...
                            <h2 class="text-white">Désolé, Une erreur est survenue</h2>
                            <p class="lead">La page que vous recherchez a été retirée ou alors a changé de nom ou encore est indisponible de manierre temporaire
                            </p><a class="btn btn-tertiary mt-3" href="{{ route('home') }}">Revenir à l'accueil</a>
                        </div>
                    </div>
                </div>
            </div>
